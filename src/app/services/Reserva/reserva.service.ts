...
export class ReservaService {
  ...
  addReserva(nuevoReserva: any): Observable<any> {
    return this._http.post('http://localhost:8080/reserva/agregarReserva', nuevoReserva);
  }

  updateReserva(updateReserva: any): Observable<any> {
    return this._http.put(`http://localhost:8080/reserva/updateReserva`, updateReserva)
  }
